...
class Photo extends Db_object
{
  ...
  protected $db_table_fields = array('id', 'title', 'caption', 'alternate_text', 'description', 'filename', 'type', 'size', 'user_id');
  public $id;
  public $title;
  public $caption;
  ...
  public function display_image_info($photo_id)
  {
    $photo = $this->find_by_id($photo_id);
